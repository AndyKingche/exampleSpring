...
import com.example.mx.repository.MateriasRepository;
...
public class MateriasController {
	...
	public ResponseEntity<String> updateMaterias(@RequestBody Materias cantones, @PathVariable Long id)
			throws ResourceNotFoundException {

		Materias encontrarMaterias = getMaterias(id)
