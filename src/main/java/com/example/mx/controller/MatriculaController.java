...
import com.example.mx.repository.MatriculaRepository;
...
public class MatriculaController {
	...
	public ResponseEntity<String> updateMatricula(@RequestBody Matricula matricula, @PathVariable Long id)
			throws ResourceNotFoundException {
		Matricula findMatricula = getIdMatriculas(id)
