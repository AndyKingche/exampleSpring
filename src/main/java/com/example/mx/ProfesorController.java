...
public class ProfesorController {
	...
	public ResponseEntity<String> updateProfesor (@RequestBody Profesor profesor, @PathVariable Long id) throws ResourceNotFoundException {
		Profesor findProfesor = getProfesores(id).orElseThrow(()-> new ResourceNotFoundException("No se encontro el id"));
